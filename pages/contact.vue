  ...
  <section>
    <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-center text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">{{ $t('contact.title') }}</h2>
        <p class="mt-2 text-lg/8 text-gray-600">{{ $t('contact.subtitle') }}</p>
      </div>

      <form @submit.prevent="submitForm" class="mx-auto mt-16 max-w-xl sm:mt-20">
        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div>
            <label for="first-name" class="block text-sm/6 font-semibold text-gray-900">{{ $t('contact.first_name') }}*</label>
            <div class="mt-2.5">
          ...
          <div>
            <label for="last-name" class="block text-sm/6 font-semibold text-gray-900">{{ $t('contact.last_name') }}*</label>
            <div class="mt-2.5">
          ...
          <div class="sm:col-span-2">
            <label for="phone-number" class="block text-sm/6 font-semibold text-gray-900">{{ $t('contact.phone') }}</label>
            <div class="mt-2.5">
