...
const projects = computed<ProjectItem[]>(() => [
  ...
  { key: 'onao', title: t('projects.onao.title'), desc: t('projects.onao.desc'), published: '2024', framework: 'Nuxt & NestJS', tags: 'Full Stack,Backend,devops', img: '/img/projects/onao.png', link: 'https://onao-beta.pages.dev/' },
  ...
  { key: 'liquidytics', title: t('projects.liquidytics.title'), desc: t('projects.liquidytics.desc'), published: '2025', framework: 'Bun + Hono & Nuxt', tags: 'Full Stack,backend,devops', img: '/img/projects/liquidytics.svg', link: 'https://liquidytics.pages.dev/' },
  { key: 'lbc-tools', title: t('projects.lbc-tools.title'), desc: t('projects.lbc-tools.desc'), published: '2026', framework: 'Javascript', tags: 'opensource,other', img: '/img/projects/lbc.png', link: 'https://github.com/Drarox/LBC-tools' },
